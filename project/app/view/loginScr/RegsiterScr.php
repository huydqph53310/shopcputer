...
<body>
    ...
    <div class="content">
        <div class="login-form">
            <h1 class="dieukhoan">Regsiter</h1>
            <br>
            <form action="" method="post">
                <span class="texs">Your Name</span><br>
                <input type="text" name="name" placeholder="name">
                <br>
                <span class="texs">Your Email</span><br>
                <input type="email" name="email" placeholder="email">
                <br>
                <span class="texs">Your Phone</span><br>
                ...
                <br>
                <br>
                <input type="submit" name="regsiter" value="Regsiter">
            </form>
        </div>
    </div>
</body>
